...
class TestKeggMap(TestCase):
    ...
    def test_correct_reversability(self):
        ...
        water = _kegg_compound("C00001")
        atp = _kegg_compound("C00002")
        o2 = _kegg_compound("C00007")
        metal = _kegg_compound("C00050")
        kegg_map.add_entry(1, water)
        kegg_map.add_entry(2, atp)
        kegg_map.add_entry(3, o2)
        kegg_map.add_entry(4, metal)
